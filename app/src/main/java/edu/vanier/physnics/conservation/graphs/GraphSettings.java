...
public class GraphSettings {
    ...
    public static final double KINETIC_ENERGY_GRAPH_POSITION_X = 200;
    public static final double POTENTIAL_ENERGY_GRAPH_POSITION_X = 400;
    public static final double FRICTION_ENERGY_GRAPH_POSITION_x = 600;
    ...
    public static final double VELOCITY_TEXT_POSITION_X = PANE_WIDTH/2-75;
    public static final double VELOCITY_TEXT_POSITION_Y = 50;
    
    public static final double CURRENT_HEIGHT_TEXT_POSITION_X = 50;
    public static final double CURRENT_HEIGHT_TEXT_POSITION_Y = 50;
    
    public static final double KINETIC_ENERGY_TEXT_POSITION_X = PANE_WIDTH/2-150; 
    public static final double KINETIC_ENERGY_TEXT_POSITION_Y = PANE_HEIGHT - 50;
    
    public static final double POTENTIAL_ENERGY_TEXT_POSITION_X = PANE_WIDTH/2+50; 
    public static final double POTENTIAL_ENERGY_TEXT_POSITION_Y = PANE_HEIGHT - 50;
    
    public static final double FRICTION_ENERGY_TEXT_POSITION_X = 50; 
